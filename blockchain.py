...
class Blockchain:
    ...
    def mine_block(self, type_data: str, Order_type: str, Qty:int ) -> dict:
            ...
            block = self._create_block(
                type_data=type_data, proof=proof, previous_hash=previous_hash, index=index,Order_type=Order_type, Qty=Qty 
            )
    ...
    def is_chain_valid(self) -> bool:
        ...
        while block_index < len(self.chain):
            ...
            previous_proof = previous_block["proof"]
            index, type_data, proof, Order_type, Qty = block["index"], block["Currency_pair"], block["proof"], block["Order_type"], block["Qty"]
